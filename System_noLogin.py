...
class RecMainWindow(QMainWindow, Ui_MainWindow):
    def __init__(self, parent=None, *args, **kwargs):
        ...
        # 加载训练的模型权重
        self.model.load_model(model_path=abs_path("weights/exam-yolov8n.pt", path_type="current"))
        self.plot_vertical_bar(self.label_bar, self.count_name, [0 for i in self.count_name], self.colors, margin=30)
